...
public class Request {
    ...
    private List<Order> products ; // it is the list of cart products of the order
    ...
    public Request(String phone, String name,  String total, String status, String comment, List<Order> products) {
        this.phone = phone;
        this.name = name;
        this.total = total;
        this.status = status;
